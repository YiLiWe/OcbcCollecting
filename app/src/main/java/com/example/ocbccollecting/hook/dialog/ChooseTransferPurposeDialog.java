...
public class ChooseTransferPurposeDialog extends BaseDialog {
    @Override
    public String getName() {
        return "Choose transfer purpose";
    }
    ...
    private void selectBank(List<View> views) {
        views.forEach(view -> {
            ...
            if (ViewUtil.equalsBank(textView, "Others")) {
                ViewUtil.performClick(view);
                getActivityLifecycleCallbacks().onMessageEvent(new MessageEvent(3));
            }
        });
    }
